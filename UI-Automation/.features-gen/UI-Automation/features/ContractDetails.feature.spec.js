...
test.describe('Contract Details Component (SLL-192)', () => {
  ...
  test('User navigates to Contract Details and sees contracts for the selected depository and effective date', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
  ...
  test('Grid displays contracts with all expected columns', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('Authorized user can access Trade, ReRate, Recall, and Return action controls', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('Read-only user cannot access Trade, ReRate, Recall, or Return action dialogs', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await Then('the Trade, ReRate, Recall, and Return action controls should not be available for the read-only user', null, { page }); 
  });

  test('User filters by Symbol/CUSIP and grid shows only matching contracts', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
  ...
  test('User filters by DTC and grid updates correctly', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('User filters by LoanetId and grid updates correctly', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('User filters by Contract No. and grid updates correctly', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('User filters by Profit Center and grid updates correctly', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('User filters by Start Date range and grid updates correctly', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('User applies a Start Date preset and grid updates correctly', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('User changes Effective Date and grid reloads with data for the new date', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('User changes selected depository and grid reloads with new depository contracts', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('Live quote banner appears when grid is filtered down to a single symbol', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await When('the user enters a symbol in the Symbol/CUSIP filter', null, { contractDetailsPage, contractSummaryPage, page }); 
  ...
  test('Live quote banner is hidden when multiple symbols are visible in the grid', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await Then('the live quote snapshot banner should not be visible', null, { contractDetailsPage }); 
  });

  test('User expands a contract row and sees contract history detail', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('User collapses an expanded history row and the detail is hidden', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('Pinned totals include only Open and Warning contracts — Closed contracts are excluded', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await Then('the pinned total row should reflect totals from Open and Warning contracts only', null, { contractDetailsPage }); 
  });

  test('Weighted average Borrow Rate and Loan Rate are calculated quantity-based', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('Inventory equals Borrow Qty minus Loan Qty in pinned totals', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await Then('the Inventory value in pinned totals should equal Borrow Qty minus Loan Qty', null, { contractDetailsPage }); 
  });

  test('Net equals Loan Amount minus Borrow Amount in pinned totals', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await Then('the Net value in pinned totals should equal Loan Amount minus Borrow Amount', null, { contractDetailsPage }); 
  });

  test('Match P&L uses daily spread between weighted borrow and loan rates on matched dollar amount', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('Funding P&L uses net dollar imbalance at 4.33 funding rate plus rebate-rate debit logic', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('Total P&L equals Funding plus Match', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await Then('the Total P&L value should equal Funding plus Match', null, { contractDetailsPage }); 
  });

  test('Pinned totals recalculate correctly after a Symbol/CUSIP filter is applied', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await When('the user enters a symbol in the Symbol/CUSIP filter', null, { contractDetailsPage, contractSummaryPage, page }); 
  ...
  test('Pinned totals recalculate correctly after all filters are cleared', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('Pinned totals show zeros when all contracts are filtered out', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('Profit Center field is editable when Effective Date is today', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('Profit Center field is read-only when Effective Date is a past date', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('Valid single-character Profit Center update submits successfully', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
  ...
  test('Blank Profit Center update is accepted and submits successfully', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
  ...
  test('Multi-character Profit Center value is rejected with a validation error', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
  ...
  test('User opens Trade panel for a single Borrow and submits successfully', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('User opens Trade panel for a single Loan and submits successfully', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await When('the user opens the Trade panel', null, { contractDetailsPage }); 
  ...
  test('User opens Trade panel in Match mode and two linked trades are created', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await When('the user opens the Trade panel', null, { contractDetailsPage }); 
  ...
  test('Symbol is prefilled when Trade panel is opened from Contract Details context', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('Trade form validates all required fields before allowing submit', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await When('the user opens the Trade panel', null, { contractDetailsPage }); 
  ...
  test('Trade form validates counterparty before allowing submit', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await When('the user opens the Trade panel', null, { contractDetailsPage }); 
  ...
  test('Trade form validates symbol/CUSIP before allowing submit', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await When('the user opens the Trade panel', null, { contractDetailsPage }); 
  ...
  test('In Match mode Loan side shows symbol and quantity read-only from Borrow side', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await When('the user opens the Trade panel', null, { contractDetailsPage }); 
    await And('the user selects both Borrow and Loan trade types', null, { contractDetailsPage }); 
  ...
  test('In Match mode Loan side requires its own counterparty, rebate rate, margin, and rounding', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await When('the user opens the Trade panel', null, { contractDetailsPage }); 
    await And('the user selects both Borrow and Loan trade types', null, { contractDetailsPage }); 
  ...
  test('ReRate dialog is enabled only when today\'s effective date is selected and at least one Open contract is selected', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
  ...
  test('ReRate dialog is disabled when no contract is selected', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await Then('the ReRate action control should be disabled', null, { contractDetailsPage }); 
  });

  test('ReRate dialog is disabled for a past effective date', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await When('the user changes the Effective Date to a past date', null, { contractDetailsPage }); 
    await Then('the ReRate action control should be disabled', null, { contractDetailsPage }); 
  ...
  test('ReRate dialog is disabled when only Closed or Warning contracts are selected', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
  ...
  test('Single selected contract shows a contract summary line in the ReRate dialog', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
  ...
  test('ReRate submit sends request for all selected contract IDs and shows success feedback', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
  ...
  test('Empty rebate rate input is rejected with a validation error in ReRate dialog', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
    await When('the user selects an Open contract row', null, { contractDetailsPage }); 
  ...
  test('Non-numeric rebate rate input is rejected with a validation error in ReRate dialog', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
    await When('the user selects an Open contract row', null, { contractDetailsPage }); 
  ...
  test('Recall dialog is enabled for exactly one selected Open loan-side contract on today\'s date', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
  ...
  test('Recall dialog is not available for borrow-side contracts', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
  ...
  test('Recall dialog is not available when more than one contract is selected', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
  ...
  test('Recall dialog is disabled for a past effective date', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await When('the user changes the Effective Date to a past date', null, { contractDetailsPage }); 
    await Then('the Recall action control should be disabled', null, { contractDetailsPage }); 
  ...
  test('Recall quantity exceeding the contract quantity is rejected', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
    await When('the user selects exactly one Open loan-side contract row', null, { contractDetailsPage }); 
  ...
  test('Valid Recall quantity submits successfully and shows success feedback', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
    await When('the user selects exactly one Open loan-side contract row', null, { contractDetailsPage }); 
  ...
  test('Return dialog is enabled for exactly one selected Open borrow-side contract on today\'s date', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
  ...
  test('Return dialog is not available for loan-side contracts', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
  ...
  test('Return dialog is not available when more than one contract is selected', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
    await When('the user selects multiple contract rows', null, { contractDetailsPage }); 
  ...
  test('Return dialog is disabled for a past effective date', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await When('the user changes the Effective Date to a past date', null, { contractDetailsPage }); 
    await Then('the Return action control should be disabled', null, { contractDetailsPage }); 
  ...
  test('Return quantity exceeding the contract quantity is rejected', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
    await When('the user selects exactly one Open borrow-side contract row', null, { contractDetailsPage }); 
  ...
  test('Same-day return acknowledgement is required when contract start date is today', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
  ...
  test('Valid Return submits with contract ID, quantity, spec flag, and batch code and shows success feedback', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await And('the Effective Date is set to today', null, { contractDetailsPage }); 
    await When('the user selects exactly one Open borrow-side contract row', null, { contractDetailsPage }); 
  ...
  test('Selected depository with no contracts shows empty grid and empty pinned totals', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('Filtering by a Symbol with no matching contracts shows empty grid and zeroed pinned totals', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    await When('the user enters "ZZZZINVALID" in the Symbol/CUSIP filter', null, { contractDetailsPage, contractSummaryPage, page }); 
    await Then('the grid should show no matching rows', null, { contractDetailsPage, contractSummaryPage, page }); 
  ...
  test.describe('Multiple filter combinations with valid, partial, and no-match inputs', () => {
    ...
    test('Example #1', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    ...
    test('Example #2', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    ...
    test('Example #3', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    ...
    test('Example #4', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
    ...
    test('Example #5', { tag: ['@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Contract Details page', null, { contractDetailsPage }); 
  ...
  test('Full lifecycle — login, navigate to Contract Details, filter, verify live quote, expand history, verify pinned totals, submit Trade', { tag: ['@Smoke', '@Regression', '@SLL-192'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
