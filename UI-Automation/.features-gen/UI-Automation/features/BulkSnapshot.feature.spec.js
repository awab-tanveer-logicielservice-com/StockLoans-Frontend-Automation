...
test.describe('Bulk Snapshot Screen — Renamed from Lending Pit Lookup (SLL-232)', () => {
  ...
  test('User navigates to Bulk Snapshot page and it loads with the correct heading and empty state', { tag: ['@Smoke', '@Regression', '@SLL-232'] }, async ({ Given, When, Then, And, bulkSnapshotPage, loginPage, page, testUsers }) => { 
  ...
  test('User enters a valid symbol and fetches rates — results are displayed in the grid', { tag: ['@Smoke', '@Regression', '@SLL-232'] }, async ({ Given, When, Then, And, bulkSnapshotPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Bulk Snapshot page', null, { bulkSnapshotPage }); 
  ...
  test('User enters multiple symbols and fetches rates — results are displayed for all symbols', { tag: ['@Smoke', '@Regression', '@SLL-232'] }, async ({ Given, When, Then, And, bulkSnapshotPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Bulk Snapshot page', null, { bulkSnapshotPage }); 
  ...
  test('Navigation menu shows "Bulk Snapshot" as the screen name', { tag: ['@Smoke', '@Regression', '@SLL-232'] }, async ({ Given, When, Then, bulkSnapshotPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
  ...
  test('Bulk Snapshot page heading displays the new screen name', { tag: ['@Smoke', '@Regression', '@SLL-232'] }, async ({ Given, When, Then, bulkSnapshotPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Bulk Snapshot page', null, { bulkSnapshotPage }); 
    await Then('the Bulk Snapshot page heading should be visible', null, { bulkSnapshotPage }); 
  });

  test('Bulk Snapshot form shows Fetch Rates button, Clear button, and Use Cached Rates checkbox', { tag: ['@Smoke', '@Regression', '@SLL-232'] }, async ({ Given, When, Then, And, bulkSnapshotPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Bulk Snapshot page', null, { bulkSnapshotPage }); 
  ...
  test('Bulk Snapshot grid displays the expected Symbol, Cusip, and Description columns', { tag: ['@Smoke', '@Regression', '@SLL-232'] }, async ({ Given, When, Then, And, bulkSnapshotPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Bulk Snapshot page', null, { bulkSnapshotPage }); 
    await When('the user enters a valid symbol in the Bulk Snapshot search field', null, { bulkSnapshotPage }); 
    await And('the user clicks the Bulk Snapshot Fetch Rates button', null, { bulkSnapshotPage }); 
  ...
  test('Search results contain a row matching the searched symbol', { tag: ['@Regression', '@SLL-232'] }, async ({ Given, When, Then, And, bulkSnapshotPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Bulk Snapshot page', null, { bulkSnapshotPage }); 
    await When('the user enters a valid symbol in the Bulk Snapshot search field', null, { bulkSnapshotPage }); 
    await And('the user clicks the Bulk Snapshot Fetch Rates button', null, { bulkSnapshotPage }); 
  ...
  test('Bulk Snapshot grid rows contain valid populated data values', { tag: ['@Regression', '@SLL-232'] }, async ({ Given, When, Then, And, bulkSnapshotPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Bulk Snapshot page', null, { bulkSnapshotPage }); 
    await When('the user enters a valid symbol in the Bulk Snapshot search field', null, { bulkSnapshotPage }); 
    await And('the user clicks the Bulk Snapshot Fetch Rates button', null, { bulkSnapshotPage }); 
  ...
  test('Clicking the Clear button resets the Symbol or Cusip textarea', { tag: ['@Regression', '@SLL-232'] }, async ({ Given, When, Then, And, bulkSnapshotPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Bulk Snapshot page', null, { bulkSnapshotPage }); 
    await When('the user enters a valid symbol in the Bulk Snapshot search field', null, { bulkSnapshotPage }); 
  ...
  test('Clicking Fetch Rates with empty textarea shows no results or empty state', { tag: ['@Regression', '@SLL-232'] }, async ({ Given, When, Then, bulkSnapshotPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Bulk Snapshot page', null, { bulkSnapshotPage }); 
  ...
  test('Searching an unknown symbol returns no rate data for that symbol', { tag: ['@Regression', '@SLL-232'] }, async ({ Given, When, Then, And, bulkSnapshotPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Bulk Snapshot page', null, { bulkSnapshotPage }); 
    await When('the user enters "ZZZZINVALID" in the Bulk Snapshot search field', null, { bulkSnapshotPage }); 
    await And('the user clicks the Bulk Snapshot Fetch Rates button', null, { bulkSnapshotPage }); 
    await Then('the Bulk Snapshot grid should show no rate data for "ZZZZINVALID"', null, { bulkSnapshotPage }); 
  });

  test('Searching with special characters in the symbol field is handled gracefully', { tag: ['@Regression', '@SLL-232'] }, async ({ Given, When, Then, And, bulkSnapshotPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Bulk Snapshot page', null, { bulkSnapshotPage }); 
  ...
  test('Bulk Snapshot page shows "No Data Available" empty state before any search is performed', { tag: ['@Regression', '@SLL-232'] }, async ({ Given, When, Then, bulkSnapshotPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Bulk Snapshot page', null, { bulkSnapshotPage }); 
    await Then('the Bulk Snapshot Ag-Grid should display the empty state overlay', null, { bulkSnapshotPage }); 
  });

  test('Grid columns remain correctly aligned after results are loaded', { tag: ['@Regression', '@SLL-232'] }, async ({ Given, When, Then, And, bulkSnapshotPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Bulk Snapshot page', null, { bulkSnapshotPage }); 
    await When('the user enters a valid symbol in the Bulk Snapshot search field', null, { bulkSnapshotPage }); 
    await And('the user clicks the Bulk Snapshot Fetch Rates button', null, { bulkSnapshotPage }); 
  ...
  test.describe('Multiple symbol searches with valid, invalid, and empty inputs', () => {
    ...
    test('Example #1', { tag: ['@Regression', '@SLL-232'] }, async ({ Given, When, Then, And, bulkSnapshotPage, loginPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await When('the user navigates to the Bulk Snapshot page', null, { bulkSnapshotPage }); 
    ...
    test('Example #2', { tag: ['@Regression', '@SLL-232'] }, async ({ Given, When, Then, And, bulkSnapshotPage, loginPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await When('the user navigates to the Bulk Snapshot page', null, { bulkSnapshotPage }); 
    ...
    test('Example #3', { tag: ['@Regression', '@SLL-232'] }, async ({ Given, When, Then, And, bulkSnapshotPage, loginPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await When('the user navigates to the Bulk Snapshot page', null, { bulkSnapshotPage }); 
    ...
    test('Example #4', { tag: ['@Regression', '@SLL-232'] }, async ({ Given, When, Then, And, bulkSnapshotPage, loginPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await When('the user navigates to the Bulk Snapshot page', null, { bulkSnapshotPage }); 
      await When('the user enters "ZZZZINVALID" in the Bulk Snapshot search field', null, { bulkSnapshotPage }); 
      await And('the user clicks the Bulk Snapshot Fetch Rates button', null, { bulkSnapshotPage }); 
    ...
    test('Example #5', { tag: ['@Regression', '@SLL-232'] }, async ({ Given, When, Then, And, bulkSnapshotPage, loginPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await When('the user navigates to the Bulk Snapshot page', null, { bulkSnapshotPage }); 
      await When('the user enters "" in the Bulk Snapshot search field', null, { bulkSnapshotPage }); 
      await And('the user clicks the Bulk Snapshot Fetch Rates button', null, { bulkSnapshotPage }); 
  ...
  test('Full lifecycle — login, verify Bulk Snapshot navigation and rename, search symbols, verify results', { tag: ['@Smoke', '@Regression', '@SLL-232'] }, async ({ Given, When, Then, And, bulkSnapshotPage, contractSummaryPage, loginPage, page, testUsers }) => { 
