...
test.describe('Add New User — Admin User Management (SLL-Users)', () => {
  ...
  test('Admin navigates to the Users Management page', { tag: ['@Smoke', '@Regression'] }, async ({ Given, When, Then, And, addNewUserPage, loginPage, page, testUsers }) => { 
  ...
  test('Opening the Add New User modal reveals all required fields', { tag: ['@Smoke', '@Regression'] }, async ({ Given, When, Then, And, addNewUserPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Users Management page', null, { addNewUserPage }); 
  ...
  test('ADD USER button is disabled when no fields are filled', { tag: ['@Smoke', '@Regression'] }, async ({ Given, When, Then, And, addNewUserPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Users Management page', null, { addNewUserPage }); 
    await And('the user clicks the ADD NEW USER button', null, { addNewUserPage }); 
  ...
  test('ADD USER button becomes enabled after all required fields are filled', { tag: ['@Smoke', '@Regression'] }, async ({ Given, When, Then, And, addNewUserPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Users Management page', null, { addNewUserPage }); 
    await And('the user clicks the ADD NEW USER button', null, { addNewUserPage }); 
  ...
  test('Invalid email format triggers a validation error on blur', { tag: ['@Smoke', '@Regression'] }, async ({ Given, When, Then, And, addNewUserPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Users Management page', null, { addNewUserPage }); 
    await And('the user clicks the ADD NEW USER button', null, { addNewUserPage }); 
  ...
  test('Valid email format does not trigger a validation error', { tag: ['@Regression'] }, async ({ Given, When, Then, And, addNewUserPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Users Management page', null, { addNewUserPage }); 
    await And('the user clicks the ADD NEW USER button', null, { addNewUserPage }); 
  ...
  test('Admin creates a new user successfully and sees a success notification', { tag: ['@Smoke', '@Regression'] }, async ({ Given, When, Then, And, addNewUserPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Users Management page', null, { addNewUserPage }); 
    await And('the user clicks the ADD NEW USER button', null, { addNewUserPage }); 
    await And('the user fills in all new user details', null, { addNewUserPage }); 
  ...
  test('Users grid refreshes automatically after a new user is saved', { tag: ['@Regression'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewUserPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Users Management page', null, { addNewUserPage }); 
    await And('the user clicks the ADD NEW USER button', null, { addNewUserPage }); 
    await And('the user fills in all new user details', null, { addNewUserPage }); 
