...
test.describe('LCOR (SLL-208)', () => {
  ...
  test('User navigates to LCOR and current-day records for the selected depository are displayed', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, lcorPage, loginPage, page, testUsers }) => { 
  ...
  test('User submits a valid LCOR batch with required fields and it is accepted', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
  ...
  test('User submits an LCOR batch with all advanced fields populated', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the LCOR page', null, { lcorPage }); 
    await And('the user selects a depository', null, { lcorPage }); 
  ...
  test('User clicks a row in the LCOR grid and the pinned detail summary is displayed', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the LCOR page', null, { lcorPage }); 
  ...
  test('User resets the LCOR form and all fields are cleared', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the LCOR page', null, { lcorPage }); 
  ...
  test('LCOR batch submission is blocked when Contra Loanet ID is missing', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the LCOR page', null, { lcorPage }); 
  ...
  test('LCOR batch submission is blocked when Symbol or CUSIP is missing', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the LCOR page', null, { lcorPage }); 
  ...
  test('LCOR batch submission is blocked when Quantity is missing', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the LCOR page', null, { lcorPage }); 
  ...
  test('Non-numeric value entered in Quantity field shows a validation error', { tag: ['@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the LCOR page', null, { lcorPage }); 
  ...
  test('Negative value entered in Quantity field shows a validation error', { tag: ['@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the LCOR page', null, { lcorPage }); 
  ...
  test('Non-numeric value entered in Min Rebate field shows a validation error', { tag: ['@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the LCOR page', null, { lcorPage }); 
  ...
  test('LCOR grid only shows current-day records for the selected depository', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the LCOR page', null, { lcorPage }); 
  ...
  test('Changing the depository on the LCOR page refreshes the grid with the new depository records', { tag: ['@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the LCOR page', null, { lcorPage }); 
    await And('the user selects a depository', null, { lcorPage }); 
