...
test.describe('Contract Management (SLL-208)', () => {
  ...
  test('User navigates to Contract Management and same-day contracts are displayed', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractManagementPage, lcorPage, loginPage, page, testUsers }) => { 
  ...
  test('User switches to the Pends view and only pending contracts are shown', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractManagementPage, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
  ...
  test('User switches to the Made view and only made contracts are shown', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractManagementPage, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Management page', null, { contractManagementPage }); 
    await And('the user selects a depository', null, { lcorPage }); 
  ...
  test('User switches to the All view and all same-day contracts are shown', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractManagementPage, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Management page', null, { contractManagementPage }); 
    await And('the user selects a depository', null, { lcorPage }); 
  ...
  test('Changing the selected depository refreshes the grid with the new depository\'s contracts', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractManagementPage, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Management page', null, { contractManagementPage }); 
    await And('the user selects a depository', null, { lcorPage }); 
  ...
  test('Contracts from other depositories are not shown for the selected depository', { tag: ['@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractManagementPage, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Management page', null, { contractManagementPage }); 
  ...
  test('Authorized user approves a submitted contract row successfully', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractManagementPage, loginPage, page, testUsers }) => { 
  ...
  test('Authorized user denies a submitted contract row successfully', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractManagementPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in with contract approval permissions', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Management page', null, { contractManagementPage }); 
    await And('the user selects a depository with submitted contracts', null, { contractManagementPage }); 
    await When('the user selects a submitted contract row', null, { contractManagementPage }); 
  ...
  test('Authorized user updates DTC status to Made for a contract', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractManagementPage, lcorPage, loginPage, page, testUsers }) => { 
  ...
  test('Authorized user updates DTC status to Pending for a contract', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractManagementPage, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in with DTC update permissions', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Management page', null, { contractManagementPage }); 
    await And('the user selects a depository', null, { lcorPage }); 
  ...
  test('User edits a notes or private comment field inline and saves successfully', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractManagementPage, lcorPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Management page', null, { contractManagementPage }); 
    await And('the user selects a depository', null, { lcorPage }); 
  ...
  test('User without approval permissions cannot approve or deny contracts', { tag: ['@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractManagementPage, loginPage, page, testUsers }) => { 
  ...
  test('User without DTC update permissions cannot toggle the DTC status', { tag: ['@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractManagementPage, lcorPage, loginPage, page, testUsers }) => { 
