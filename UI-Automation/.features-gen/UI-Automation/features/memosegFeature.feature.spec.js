...
test.describe('Memo Seg - Create instruction batches and perform UN-SEG actions', () => {
  ...
  test('User creates a valid memo seg batch and views populated summary and detail grids', { tag: ['@Smoke', '@Regression', '@SLL-204'] }, async ({ Given, When, Then, And, loginPage, memoSegPage, page, testUsers }) => { 
  ...
  test('Authenticated user can access the Memo Seg page and see the text input area', { tag: ['@Smoke', '@Regression', '@SLL-204'] }, async ({ Given, Then, And, loginPage, memoSegPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Memo Seg page', null, { memoSegPage }); 
    await Then('the Memo Seg page should be visible with the text input area', null, { memoSegPage }); 
  });

  test('UN-SEG button is visible on the Memo Seg page before any batch is submitted', { tag: ['@Smoke', '@Regression', '@SLL-204'] }, async ({ Given, When, Then, And, loginPage, memoSegPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Memo Seg page', null, { memoSegPage }); 
  ...
  test('User performs UN-SEG action on a grouped row in the summary grid', { tag: ['@Smoke', '@Regression', '@SLL-204'] }, async ({ Given, When, Then, And, loginPage, memoSegPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Memo Seg page', null, { memoSegPage }); 
  ...
  test('Summary grid groups batch rows by symbol after submission', { tag: ['@Smoke', '@Regression', '@SLL-204'] }, async ({ Given, When, Then, And, loginPage, memoSegPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Memo Seg page', null, { memoSegPage }); 
  ...
  test('UN-SEG button remains visible after batch submission with no row selected', { tag: ['@Smoke', '@Regression', '@SLL-204'] }, async ({ Given, When, Then, And, loginPage, memoSegPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Memo Seg page', null, { memoSegPage }); 
    await And('the user enters "AAPL 100" in the memo seg text input', null, { memoSegPage }); 
    await And('the user submits the memo seg batch', null, { memoSegPage }); 
  ...
  test('User submits an empty text input and receives a required field validation error', { tag: ['@Smoke', '@Regression', '@SLL-204'] }, async ({ Given, When, Then, And, loginPage, memoSegPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Memo Seg page', null, { memoSegPage }); 
  ...
  test('User enters a symbol without quantity and receives a validation error', { tag: ['@Smoke', '@Regression', '@SLL-204'] }, async ({ Given, When, Then, And, loginPage, memoSegPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Memo Seg page', null, { memoSegPage }); 
  ...
  test('User enters a non-numeric quantity and receives a format validation error', { tag: ['@Smoke', '@Regression', '@SLL-204'] }, async ({ Given, When, Then, And, loginPage, memoSegPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Memo Seg page', null, { memoSegPage }); 
  ...
  test.describe('User enters a boundary quantity value and receives the expected system response', () => {
    ...
    test('Example #1', { tag: ['@Smoke', '@Regression', '@SLL-204'] }, async ({ Given, When, Then, And, loginPage, memoSegPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Memo Seg page', null, { memoSegPage }); 
    ...
    test('Example #2', { tag: ['@Smoke', '@Regression', '@SLL-204'] }, async ({ Given, When, Then, And, loginPage, memoSegPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Memo Seg page', null, { memoSegPage }); 
    ...
    test('Example #3', { tag: ['@Smoke', '@Regression', '@SLL-204'] }, async ({ Given, When, Then, And, loginPage, memoSegPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Memo Seg page', null, { memoSegPage }); 
  ...
  test('User enters special characters as symbol and receives a validation error', { tag: ['@Smoke', '@Regression', '@SLL-204'] }, async ({ Given, When, Then, And, loginPage, memoSegPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Memo Seg page', null, { memoSegPage }); 
  ...
  test('Clearing the text input after batch submission resets both summary and detail grids', { tag: ['@Smoke', '@Regression', '@SLL-204'] }, async ({ Given, When, Then, And, loginPage, memoSegPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Memo Seg page', null, { memoSegPage }); 
    await And('the user enters "AAPL 100" in the memo seg text input', null, { memoSegPage }); 
    await And('the user submits the memo seg batch', null, { memoSegPage }); 
  ...
  test('Detail grid displays the correct column headers after batch submission', { tag: ['@Smoke', '@Regression', '@SLL-204'] }, async ({ Given, Then, And, loginPage, memoSegPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Memo Seg page', null, { memoSegPage }); 
    await And('the user enters "AAPL 100" in the memo seg text input', null, { memoSegPage }); 
    await And('the user submits the memo seg batch', null, { memoSegPage }); 
  ...
  test('Full lifecycle - user creates a memo seg batch and completes a UN-SEG action end to end', { tag: ['@Smoke', '@Regression', '@SLL-204'] }, async ({ Given, When, Then, And, loginPage, memoSegPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Memo Seg page', null, { memoSegPage }); 
