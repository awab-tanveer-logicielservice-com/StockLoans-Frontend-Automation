...
test.describe('Short Rate Adjustment (SRA)', () => {
  ...
  test('User navigates to Short Rate Adjustment page and views the grid', { tag: ['@Smoke', '@Regression', '@SRA'] }, async ({ Given, When, Then, And, loginPage, page, shortRateAdjustmentPage, testUsers }) => { 
  ...
  test('Short Rate Adjustment grid displays the correct column headers', { tag: ['@Smoke', '@Regression', '@SRA'] }, async ({ Given, When, Then, loginPage, page, shortRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Short Rate Adjustment page', null, { shortRateAdjustmentPage }); 
    await Then('the grid should display Symbol, Cusip, Rate and Source columns', null, { shortRateAdjustmentPage }); 
  });

  test('User selects the first row in the Short Rate Adjustment grid', { tag: ['@Smoke', '@Regression', '@SRA'] }, async ({ Given, When, Then, And, loginPage, page, shortRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
  ...
  test('Authorized user successfully updates a short rate and saves', { tag: ['@Smoke', '@Regression', '@SRA'] }, async ({ Given, When, Then, And, loginPage, page, shortRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Short Rate Adjustment page', null, { shortRateAdjustmentPage }); 
    await When('the user selects the first row in the short rate grid', null, { shortRateAdjustmentPage }); 
  ...
  test('Short Rate Adjustment page uses Ag-Grid for data display', { tag: ['@Smoke', '@Regression', '@SRA'] }, async ({ Given, When, Then, loginPage, page, shortRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Short Rate Adjustment page', null, { shortRateAdjustmentPage }); 
    await Then('the Short Rate Adjustment ag-grid root should be visible', null, { shortRateAdjustmentPage }); 
  });

  test('Rate input is disabled before any row is selected and enabled after selection', { tag: ['@Regression', '@SRA'] }, async ({ Given, When, Then, And, loginPage, page, shortRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Short Rate Adjustment page', null, { shortRateAdjustmentPage }); 
  ...
  test('User cannot save a short rate without first selecting a row', { tag: ['@Regression', '@SRA'] }, async ({ Given, When, Then, And, loginPage, page, shortRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Short Rate Adjustment page', null, { shortRateAdjustmentPage }); 
  ...
  test('User clears the rate field and attempts to save - validation error shown', { tag: ['@Regression', '@SRA'] }, async ({ Given, When, Then, And, loginPage, page, shortRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Short Rate Adjustment page', null, { shortRateAdjustmentPage }); 
  ...
  test('User enters a negative rate value - validation error shown', { tag: ['@Regression', '@SRA'] }, async ({ Given, When, Then, And, loginPage, page, shortRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Short Rate Adjustment page', null, { shortRateAdjustmentPage }); 
    await And('the user selects the first row in the short rate grid', null, { shortRateAdjustmentPage }); 
  ...
  test.describe('User submits various rate values and sees expected outcomes', () => {
    ...
    test('Example #1', { tag: ['@Regression', '@SRA'] }, async ({ Given, When, Then, And, loginPage, page, shortRateAdjustmentPage, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Short Rate Adjustment page', null, { shortRateAdjustmentPage }); 
      await And('the user selects the first row in the short rate grid', null, { shortRateAdjustmentPage }); 
    ...
    test('Example #2', { tag: ['@Regression', '@SRA'] }, async ({ Given, When, Then, And, loginPage, page, shortRateAdjustmentPage, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Short Rate Adjustment page', null, { shortRateAdjustmentPage }); 
      await And('the user selects the first row in the short rate grid', null, { shortRateAdjustmentPage }); 
    ...
    test('Example #3', { tag: ['@Regression', '@SRA'] }, async ({ Given, When, Then, And, loginPage, page, shortRateAdjustmentPage, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Short Rate Adjustment page', null, { shortRateAdjustmentPage }); 
      await And('the user selects the first row in the short rate grid', null, { shortRateAdjustmentPage }); 
    ...
    test('Example #4', { tag: ['@Regression', '@SRA'] }, async ({ Given, When, Then, And, loginPage, page, shortRateAdjustmentPage, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Short Rate Adjustment page', null, { shortRateAdjustmentPage }); 
      await And('the user selects the first row in the short rate grid', null, { shortRateAdjustmentPage }); 
  ...
  test('Short Rate Adjustment grid shows empty state when no data is available', { tag: ['@Regression', '@SRA'] }, async ({ Given, When, Then, And, loginPage, page, shortRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Short Rate Adjustment page', null, { shortRateAdjustmentPage }); 
  ...
  test('Full lifecycle - login, navigate to Short Rate Adjustment, update rate and confirm', { tag: ['@Smoke', '@Regression', '@SRA'] }, async ({ Given, When, Then, And, contractSummaryPage, loginPage, page, shortRateAdjustmentPage, testUsers }) => { 
