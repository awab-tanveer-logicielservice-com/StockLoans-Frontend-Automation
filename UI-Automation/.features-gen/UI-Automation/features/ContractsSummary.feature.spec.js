...
test.describe('Contracts Summary Component (SLL-191)', () => {
  ...
  test('User navigates to Contract Summary page and sees summary-level positions loaded for the selected depository', { tag: ['@Smoke', '@Regression', '@SLL-191'] }, async ({ Given, When, Then, And, contractSummaryPage, loginPage, page, testUsers }) => { 
  ...
  test('Summary grid displays aggregated borrow and loan rates, quantities, amounts, and all calculated fields', { tag: ['@Smoke', '@Regression', '@SLL-191'] }, async ({ Given, Then, And, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
  ...
  test('User filters by Symbol/CUSIP and grid updates to show only matching rows', { tag: ['@Smoke', '@Regression', '@SLL-191'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Summary page', null, { contractSummaryPage }); 
  ...
  test('User filters by DTC and grid updates correctly', { tag: ['@Regression', '@SLL-191'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Summary page', null, { contractSummaryPage }); 
  ...
  test('User filters by LoanetId and grid updates correctly', { tag: ['@Regression', '@SLL-191'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Summary page', null, { contractSummaryPage }); 
  ...
  test('User filters by Contract No. and grid updates correctly', { tag: ['@Regression', '@SLL-191'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Summary page', null, { contractSummaryPage }); 
  ...
  test('User filters by Profit Center and grid updates correctly', { tag: ['@Regression', '@SLL-191'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Summary page', null, { contractSummaryPage }); 
  ...
  test('User changes Effective Date and summary grid data reloads for that date', { tag: ['@Smoke', '@Regression', '@SLL-191'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Summary page', null, { contractSummaryPage }); 
  ...
  test('User enables the Details toggle and the lower detail panel becomes visible', { tag: ['@Smoke', '@Regression', '@SLL-191'] }, async ({ Given, When, Then, And, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Summary page', null, { contractSummaryPage }); 
  ...
  test('Detail panel syncs to the symbol of the currently selected summary row', { tag: ['@Smoke', '@Regression', '@SLL-191'] }, async ({ Given, When, Then, And, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Summary page', null, { contractSummaryPage }); 
  ...
  test('User selects a different summary row and detail panel updates to the new symbol', { tag: ['@Regression', '@SLL-191'] }, async ({ Given, When, Then, And, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Summary page', null, { contractSummaryPage }); 
    await And('the user enables the Details toggle', null, { contractSummaryPage }); 
  ...
  test('User disables the Details toggle and the detail panel is hidden', { tag: ['@Regression', '@SLL-191'] }, async ({ Given, When, Then, And, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Summary page', null, { contractSummaryPage }); 
    await And('the user enables the Details toggle', null, { contractSummaryPage }); 
  ...
  test('User double-clicks a summary row and is navigated to Contract Details prefiltered to that symbol', { tag: ['@Smoke', '@Regression', '@SLL-191'] }, async ({ Given, When, Then, And, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Summary page', null, { contractSummaryPage }); 
  ...
  test('Contract Details page opened via double-click shows only contracts for the double-clicked symbol', { tag: ['@Regression', '@SLL-191'] }, async ({ Given, When, Then, And, contractSummaryPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Summary page', null, { contractSummaryPage }); 
    await When('the user double-clicks a summary row', null, { contractSummaryPage }); 
  ...
  test('Full lifecycle — login, select depository, view summary, apply filter, verify pinned totals, toggle details, double-click row, verify Contract Details', { tag: ['@Smoke', '@Regression', '@SLL-191'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
