...
test.describe('FPL Accounts - SLS Account Editable Dropdown Column (SLL-234)', () => {
  ...
  test('User selects an SLS account from the editable dropdown and the record updates', { tag: ['@Smoke', '@Regression', '@SLL-234', '@SLL-C1564'] }, async ({ Given, When, Then, And, fplAccountPage, loginPage, page, testUsers }) => { 
  ...
  test('SLS Account column is present in the FPL Accounts table', { tag: ['@Smoke', '@Regression', '@SLL-234', '@SLL-C1565'] }, async ({ Given, When, Then, And, fplAccountPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to FPL Accounts', null, { fplAccountPage }); 
    await And('the user closes the sidebar', null, { fplAccountPage }); 
    await Then('the account row should be visible', null, { fplAccountPage }); 
  ...
  test('SLS Account dropdown is populated with available SLS accounts', { tag: ['@Smoke', '@Regression', '@SLL-234', '@SLL-C1566'] }, async ({ Given, When, Then, And, fplAccountPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to FPL Accounts', null, { fplAccountPage }); 
    await And('the user closes the sidebar', null, { fplAccountPage }); 
    await Then('the account row should be visible', null, { fplAccountPage }); 
  ...
  test('User dismisses the SLS Account dropdown without making a selection', { tag: ['@Smoke', '@Regression', '@SLL-234', '@SLL-C1567'] }, async ({ Given, When, Then, And, fplAccountPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to FPL Accounts', null, { fplAccountPage }); 
    await And('the user closes the sidebar', null, { fplAccountPage }); 
    await Then('the account row should be visible', null, { fplAccountPage }); 
  ...
  test.describe('User selects different SLS accounts from the editable dropdown', () => {
    ...
    test('Example #1', { tag: ['@Smoke', '@Regression', '@SLL-234', '@SLL-C1568'] }, async ({ Given, When, Then, And, fplAccountPage, loginPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await When('the user navigates to FPL Accounts', null, { fplAccountPage }); 
      await And('the user closes the sidebar', null, { fplAccountPage }); 
      await Then('the account row should be visible', null, { fplAccountPage }); 
    ...
    test('Example #2', { tag: ['@Smoke', '@Regression', '@SLL-234', '@SLL-C1568'] }, async ({ Given, When, Then, And, fplAccountPage, loginPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await When('the user navigates to FPL Accounts', null, { fplAccountPage }); 
      await And('the user closes the sidebar', null, { fplAccountPage }); 
      await Then('the account row should be visible', null, { fplAccountPage }); 
    ...
    test('Example #3', { tag: ['@Smoke', '@Regression', '@SLL-234', '@SLL-C1568'] }, async ({ Given, When, Then, And, fplAccountPage, loginPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await When('the user navigates to FPL Accounts', null, { fplAccountPage }); 
      await And('the user closes the sidebar', null, { fplAccountPage }); 
      await Then('the account row should be visible', null, { fplAccountPage }); 
      await When('the user clicks the SLS Account cell for a row', null, { fplAccountPage }); 
      await Then('the SLS Account dropdown should be visible with available options', null, { fplAccountPage }); 
      await When('the user selects the SLS account option "FGM1"', null, { fplAccountPage }); 
      await Then('the record should reflect the selected SLS account', null, { fplAccountPage }); 
    });

  });

  test('Full lifecycle - navigate to FPL Accounts, edit SLS Account dropdown and verify record update', { tag: ['@Smoke', '@Regression', '@SLL-234', '@SLL-C1569'] }, async ({ Given, When, Then, And, fplAccountPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to FPL Accounts', null, { fplAccountPage }); 
    await And('the user closes the sidebar', null, { fplAccountPage }); 
    await Then('the account row should be visible', null, { fplAccountPage }); 
