...
test.describe('Short Interest Rate Adjustment Component (SLL-203)', () => {
  ...
  test('User navigates to Short Interest Rate Adjustment page and views data loaded in Ag-Grid', { tag: ['@Smoke', '@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
  ...
  test('Authorized user successfully adjusts a short interest rate and saves', { tag: ['@Smoke', '@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
  ...
  test('Authorized trader user can edit rate cells in the adjustment grid', { tag: ['@Smoke', '@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Short Interest Rate Adjustment page', null, { shortInterestRateAdjustmentPage }); 
    await When('the user selects the first row in the rate adjustment grid', null, { shortInterestRateAdjustmentPage }); 
  ...
  test('Read-only user cannot edit rate cells in the adjustment grid', { tag: ['@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Short Interest Rate Adjustment page', null, { shortInterestRateAdjustmentPage }); 
  ...
  test('Short Interest Rate Adjustment page displays correct Ag-Grid column headers', { tag: ['@Smoke', '@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Short Interest Rate Adjustment page', null, { shortInterestRateAdjustmentPage }); 
  ...
  test('Short Interest Rate Adjustment page renders with theme-aware styling consistent with V2 design system', { tag: ['@Regression', '@SLL-203'] }, async ({ Given, When, Then, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Short Interest Rate Adjustment page', null, { shortInterestRateAdjustmentPage }); 
    await Then('the page container should be visible with V2 theme styling applied', null, { shortInterestRateAdjustmentPage }); 
  });

  test('User cannot save a rate adjustment without first selecting a row', { tag: ['@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Short Interest Rate Adjustment page', null, { shortInterestRateAdjustmentPage }); 
  ...
  test('User must select a row before the rate input field becomes active', { tag: ['@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Short Interest Rate Adjustment page', null, { shortInterestRateAdjustmentPage }); 
  ...
  test('User clears the rate field and attempts to save - validation error is shown', { tag: ['@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Short Interest Rate Adjustment page', null, { shortInterestRateAdjustmentPage }); 
  ...
  test('User enters a non-numeric value in the rate field - validation error is shown', { tag: ['@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Short Interest Rate Adjustment page', null, { shortInterestRateAdjustmentPage }); 
    await And('the user selects the first row in the rate adjustment grid', null, { shortInterestRateAdjustmentPage }); 
  ...
  test('User enters a negative rate value - validation error is shown', { tag: ['@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Short Interest Rate Adjustment page', null, { shortInterestRateAdjustmentPage }); 
    await And('the user selects the first row in the rate adjustment grid', null, { shortInterestRateAdjustmentPage }); 
  ...
  test.describe('User submits rate adjustment with various valid and boundary rate values', () => {
    ...
    test('Example #1', { tag: ['@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Short Interest Rate Adjustment page', null, { shortInterestRateAdjustmentPage }); 
      await And('the user selects the first row in the rate adjustment grid', null, { shortInterestRateAdjustmentPage }); 
    ...
    test('Example #2', { tag: ['@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Short Interest Rate Adjustment page', null, { shortInterestRateAdjustmentPage }); 
      await And('the user selects the first row in the rate adjustment grid', null, { shortInterestRateAdjustmentPage }); 
    ...
    test('Example #3', { tag: ['@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Short Interest Rate Adjustment page', null, { shortInterestRateAdjustmentPage }); 
      await And('the user selects the first row in the rate adjustment grid', null, { shortInterestRateAdjustmentPage }); 
    ...
    test('Example #4', { tag: ['@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Short Interest Rate Adjustment page', null, { shortInterestRateAdjustmentPage }); 
      await And('the user selects the first row in the rate adjustment grid', null, { shortInterestRateAdjustmentPage }); 
    ...
    test('Example #5', { tag: ['@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Short Interest Rate Adjustment page', null, { shortInterestRateAdjustmentPage }); 
      await And('the user selects the first row in the rate adjustment grid', null, { shortInterestRateAdjustmentPage }); 
  ...
  test('Short Interest Rate Adjustment grid shows empty state when no data is available', { tag: ['@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Short Interest Rate Adjustment page', null, { shortInterestRateAdjustmentPage }); 
  ...
  test('User enters maximum allowed characters in rate field', { tag: ['@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Short Interest Rate Adjustment page', null, { shortInterestRateAdjustmentPage }); 
    await And('the user selects the first row in the rate adjustment grid', null, { shortInterestRateAdjustmentPage }); 
  ...
  test('Grid displays an error state when SLS V1 endpoint fails to return data', { tag: ['@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Short Interest Rate Adjustment page', null, { shortInterestRateAdjustmentPage }); 
  ...
  test('Full lifecycle - user logs in, navigates to rate adjustment, modifies rate and confirms save', { tag: ['@Smoke', '@Regression', '@SLL-203'] }, async ({ Given, When, Then, And, contractSummaryPage, loginPage, page, shortInterestRateAdjustmentPage, testUsers }) => { 
