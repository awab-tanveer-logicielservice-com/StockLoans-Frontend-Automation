...
test.describe('Security Master - Search, Edit & Contract Updates (SLL-188)', () => {
  ...
  test('Full lifecycle — search security, edit fields, enable contract update, commit update, verify grid', { tag: ['@Smoke', '@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, contractSummaryPage, loginPage, page, testUsers }) => { 
