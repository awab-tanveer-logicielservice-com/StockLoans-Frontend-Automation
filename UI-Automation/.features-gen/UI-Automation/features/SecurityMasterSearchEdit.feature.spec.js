...
test.describe('Security Master - Search, Edit & Contract Updates (SLL-188)', () => {
  ...
  test('User searches for a security by Symbol and results appear in the grid', { tag: ['@Smoke', '@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
  ...
  test('User selects a security record and the editable detail view is populated', { tag: ['@Smoke', '@Regression', '@SLL-188'] }, async ({ Given, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
  ...
  test('User edits security fields and saves successfully', { tag: ['@Smoke', '@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user searches for and selects a security record', null, { addNewSecurityPage }); 
  ...
  test('User enables the Update Contract toggle and the contract sub-view appears', { tag: ['@Smoke', '@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user searches for and selects a security record', null, { addNewSecurityPage }); 
  ...
  test('User fills contract update fields and clicks Update to commit changes', { tag: ['@Smoke', '@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user searches for and selects a security record', null, { addNewSecurityPage }); 
  ...
  test('User searches by CUSIP and matching records are returned', { tag: ['@Smoke', '@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
  ...
  test('Search returns no results for a non-existent Symbol', { tag: ['@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
  ...
  test('Search field is cleared and grid resets to default state', { tag: ['@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
  ...
  test('Search with partial Symbol returns relevant results', { tag: ['@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
  ...
  test('All editable fields are enabled when a security is selected', { tag: ['@Smoke', '@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
  ...
  test('Detail view is empty or hidden before a security is selected', { tag: ['@Regression', '@SLL-188'] }, async ({ Given, When, Then, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await Then('the editable detail view should not be visible or should be empty', null, { addNewSecurityPage }); 
  });

  test('Selecting a different security in the grid updates the detail view', { tag: ['@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user searches for and selects a security record', null, { addNewSecurityPage }); 
  ...
  test('Update Contract toggle is visible in the detail view', { tag: ['@Smoke', '@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await When('the user searches for and selects a security record', null, { addNewSecurityPage }); 
  ...
  test('Update Contract toggle is disabled by default', { tag: ['@Smoke', '@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await When('the user searches for and selects a security record', null, { addNewSecurityPage }); 
  ...
  test('Disabling the Update Contract toggle hides the contract sub-view', { tag: ['@Smoke', '@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user searches for and selects a security record', null, { addNewSecurityPage }); 
    await And('the user enables the Update Contract toggle switch', null, { addNewSecurityPage }); 
  ...
  test('Update button is disabled when Existing Symbol and CUSIP are empty', { tag: ['@Smoke', '@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user searches for and selects a security record', null, { addNewSecurityPage }); 
    await When('the user enables the Update Contract toggle switch', null, { addNewSecurityPage }); 
  ...
  test('Update button becomes enabled when both Existing Symbol and CUSIP are filled', { tag: ['@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user searches for and selects a security record', null, { addNewSecurityPage }); 
    await And('the user enables the Update Contract toggle switch', null, { addNewSecurityPage }); 
  ...
  test('Update button remains disabled when only Existing Symbol is filled', { tag: ['@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user searches for and selects a security record', null, { addNewSecurityPage }); 
    await And('the user enables the Update Contract toggle switch', null, { addNewSecurityPage }); 
  ...
  test('Update button remains disabled when only Existing CUSIP is filled', { tag: ['@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user searches for and selects a security record', null, { addNewSecurityPage }); 
    await And('the user enables the Update Contract toggle switch', null, { addNewSecurityPage }); 
  ...
  test('Non-numeric value in Close Price field shows validation error', { tag: ['@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user searches for and selects a security record', null, { addNewSecurityPage }); 
  ...
  test('Negative value in Close Price field shows validation error', { tag: ['@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user searches for and selects a security record', null, { addNewSecurityPage }); 
  ...
  test('Invalid date format in Close Date field shows validation error', { tag: ['@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user searches for and selects a security record', null, { addNewSecurityPage }); 
  ...
  test('Clearing a required field disables the Save button', { tag: ['@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user searches for and selects a security record', null, { addNewSecurityPage }); 
  ...
  test('Security Master page uses Ag-Grid for search results display', { tag: ['@Smoke', '@Regression', '@SLL-188'] }, async ({ Given, When, Then, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await Then('the security records should be displayed in an Ag-Grid component', null, { addNewSecurityPage }); 
  });

  test('Detail view inputs are theme-aware and match SLS V2 styling', { tag: ['@Smoke', '@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await When('the user searches for and selects a security record', null, { addNewSecurityPage }); 
  ...
  test('Layout is presented as a single-screen view with no page navigation required', { tag: ['@Regression', '@SLL-188'] }, async ({ Given, When, Then, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await Then('the search, grid, and detail view should all be visible on a single screen', null, { addNewSecurityPage }); 
  });

  test('Editing a security does not automatically trigger a contract update', { tag: ['@Smoke', '@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user searches for and selects a security record', null, { addNewSecurityPage }); 
  ...
  test('Contract update with a non-existent Existing Symbol shows an appropriate error', { tag: ['@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user searches for and selects a security record', null, { addNewSecurityPage }); 
    await And('the user enables the Update Contract toggle switch', null, { addNewSecurityPage }); 
  ...
  test('Cancelling the edit does not persist changes to the security record', { tag: ['@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user searches for and selects a security record', null, { addNewSecurityPage }); 
  ...
  test('Search field with only whitespace does not execute a search', { tag: ['@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
  ...
  test('Search with special characters is handled gracefully', { tag: ['@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
  ...
  test('Volume field in detail view rejects negative values', { tag: ['@Regression', '@SLL-188'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user searches for and selects a security record', null, { addNewSecurityPage }); 
  ...
  test('Full lifecycle — search security, edit fields, enable contract update, commit update, verify grid', { tag: ['@Smoke', '@Regression', '@SLL-188', '@slow'] }, async ({ Given, When, Then, And, addNewSecurityPage, contractSummaryPage, loginPage, page, testUsers }) => { 
