...
test.describe('Security Master - Add New Security Functionality (SLL-187)', () => {
  ...
  test('User clicks Add Security button and the modal dialog opens', { tag: ['@Smoke', '@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
  ...
  test('User fills all required fields and saves — new security record is created and Ag-Grid refreshes', { tag: ['@Smoke', '@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
  ...
  test('User fills all required and optional fields and saves successfully', { tag: ['@Smoke', '@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
    await When('the user fills in all required security fields', null, { addNewSecurityPage }); 
  ...
  test('Authorized user can see and click the Add Security button on the toolbar', { tag: ['@Smoke', '@Regression', '@SLL-187'] }, async ({ Given, When, Then, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await Then('the Add New Security button should be visible and enabled on the toolbar', null, { addNewSecurityPage }); 
  });

  test('Read-only user cannot see or access the Add Security button', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await Then('the Add New Security button should not be available for the read-only user', null, { addNewSecurityPage }); 
  });

  test('Add Security button is visible on the Security Master toolbar', { tag: ['@Smoke', '@Regression', '@SLL-187'] }, async ({ Given, When, Then, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await Then('the Add New Security button should be visible on the Security Master toolbar', null, { addNewSecurityPage }); 
  });

  test('Modal opens centered on screen with theme-aware styling applied', { tag: ['@Smoke', '@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
  ...
  test('Modal contains all required fields — Symbol, CUSIP, Description, Close Price, Close Date', { tag: ['@Smoke', '@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await When('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Modal contains optional fields — Exchange, Volume, Status', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await When('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Save button is disabled when the form is empty', { tag: ['@Smoke', '@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await When('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Save button becomes enabled only when all required fields are populated', { tag: ['@Smoke', '@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
    await When('the user fills in all required security fields', null, { addNewSecurityPage }); 
  ...
  test('Ag-Grid refreshes after a new security is successfully created', { tag: ['@Smoke', '@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
    await When('the user fills in all required security fields', null, { addNewSecurityPage }); 
  ...
  test('Modal closes after successful save', { tag: ['@Smoke', '@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
    await When('the user fills in all required security fields', null, { addNewSecurityPage }); 
  ...
  test('Save button remains disabled when Symbol is missing', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Save button remains disabled when CUSIP is missing', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Save button remains disabled when Description is missing', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Save button remains disabled when Close Price is missing', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Save button remains disabled when Close Date is missing', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Non-numeric value entered in Close Price field — validation error shown', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Non-numeric value entered in Volume field — validation error shown', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Negative value entered in Close Price — validation error shown', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Negative value entered in Volume — validation error shown', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Invalid date format entered in Close Date — validation error shown', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Volume at minimum boundary zero is accepted', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Volume below minimum boundary negative is rejected', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Very large Volume value is accepted or boundary error is shown', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Optional fields can be left blank and form saves successfully with only required fields', { tag: ['@Smoke', '@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
    await When('the user fills in all required security fields', null, { addNewSecurityPage }); 
  ...
  test('User cancels the modal without saving — no record is created and Ag-Grid is unchanged', { tag: ['@Smoke', '@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Newly created security appears in the Ag-Grid after successful save', { tag: ['@Smoke', '@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
    await When('the user fills in all required security fields', null, { addNewSecurityPage }); 
  ...
  test('Symbol field with special characters is handled appropriately', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('CUSIP field at maximum allowed length is accepted', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Description field with maximum allowed characters is accepted', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('User submits a duplicate Symbol — appropriate error or warning is shown', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
    await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test.describe('Multiple combinations of security field values including valid, missing, and invalid inputs', () => {
    ...
    test('Example #1', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
      await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
    ...
    test('Example #2', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
      await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
    ...
    test('Example #3', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
      await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
    ...
    test('Example #4', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
      await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
      await When('the user enters "" in the Symbol field', null, { addNewSecurityPage }); 
    ...
    test('Example #5', { tag: ['@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewSecurityPage, loginPage, page, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await And('the user navigates to the Security Master page', null, { addNewSecurityPage }); 
      await And('the user clicks the Add New Security button', null, { addNewSecurityPage }); 
  ...
  test('Full lifecycle — login, navigate to Security Master, click Add Security, fill all fields, save, verify new record in Ag-Grid', { tag: ['@Smoke', '@Regression', '@SLL-187'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, addNewSecurityPage, contractSummaryPage, loginPage, page, testUsers }) => { 
