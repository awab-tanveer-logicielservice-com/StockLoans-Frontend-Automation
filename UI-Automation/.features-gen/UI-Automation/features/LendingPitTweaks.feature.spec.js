...
test.describe('Lending Pit UI Tweaks and Ag-Grid Migration (SLL-206)', () => {
  ...
  test('User navigates to Lending Pit page and it loads with Ag-Grid displaying data', { tag: ['@Smoke', '@Regression', '@SLL-206'] }, async ({ Given, When, Then, And, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
  ...
  test('User searches for a valid symbol and results are displayed in Ag-Grid', { tag: ['@Smoke', '@Regression', '@SLL-206'] }, async ({ Given, When, Then, And, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
  ...
  test('Lending Pit page header styling is visually consistent with the rest of the application', { tag: ['@Smoke', '@Regression', '@SLL-206'] }, async ({ Given, When, Then, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
    await Then('the Lending Pit page header should be visible with consistent styling', null, { searchLendingPitLookUpPage }); 
  });

  test('Lending Pit buttons are styled consistently with the rest of the application', { tag: ['@Smoke', '@Regression', '@SLL-206'] }, async ({ Given, When, Then, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
    await Then('the Lending Pit page buttons should be visible with consistent styling', null, { searchLendingPitLookUpPage }); 
  });

  test('Lending Pit grid uses the Ag-Grid component instead of a legacy table', { tag: ['@Smoke', '@Regression', '@SLL-206'] }, async ({ Given, When, Then, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
    await Then('the Lending Pit grid should use the Ag-Grid component', null, { searchLendingPitLookUpPage }); 
  });

  test('Lending Pit headings are styled consistently with the rest of the application', { tag: ['@Regression', '@SLL-206'] }, async ({ Given, When, Then, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
    await Then('the Lending Pit page headings should be visible with consistent styling', null, { searchLendingPitLookUpPage }); 
  });

  test('Lending Pit color scheme matches the application-wide design system', { tag: ['@Regression', '@SLL-206'] }, async ({ Given, When, Then, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
    await Then('the Lending Pit page container should have consistent theme colors applied', null, { searchLendingPitLookUpPage }); 
  });

  test('Ag-Grid displays the expected columns matching the previous grid', { tag: ['@Smoke', '@Regression', '@SLL-206'] }, async ({ Given, When, Then, And, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
    await When('the user enters a valid symbol in the search field', null, { searchLendingPitLookUpPage }); 
    await And('the user clicks the submit button', null, { searchLendingPitLookUpPage }); 
  ...
  test('Search functionality works correctly after switching to Ag-Grid', { tag: ['@Smoke', '@Regression', '@SLL-206'] }, async ({ Given, When, Then, And, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
    await When('the user enters a valid symbol in the search field', null, { searchLendingPitLookUpPage }); 
    await And('the user clicks the submit button', null, { searchLendingPitLookUpPage }); 
  ...
  test('Ag-Grid column headers render correctly and match application styling', { tag: ['@Regression', '@SLL-206'] }, async ({ Given, When, Then, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
    await Then('the Ag-Grid header row should be visible with correctly styled column headers', null, { searchLendingPitLookUpPage }); 
  });

  test('Row data in Ag-Grid is correctly populated from SLS V1 endpoints', { tag: ['@Regression', '@SLL-206'] }, async ({ Given, When, Then, And, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
    await When('the user enters a valid symbol in the search field', null, { searchLendingPitLookUpPage }); 
    await And('the user clicks the submit button', null, { searchLendingPitLookUpPage }); 
  ...
  test('Search submitted with empty Symbol/CUSIP field — no results or validation state shown', { tag: ['@Regression', '@SLL-206'] }, async ({ Given, When, Then, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
  ...
  test('Search with an unknown symbol — Ag-Grid returns no rate data for that symbol', { tag: ['@Regression', '@SLL-206'] }, async ({ Given, When, Then, And, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
    await When('the user enters "ZZZZINVALID" in the Lending Pit search field', null, { searchLendingPitLookUpPage }); 
    await And('the user clicks the submit button', null, { searchLendingPitLookUpPage }); 
    await Then('the Lending Pit grid should show no rate data for "ZZZZINVALID"', null, { searchLendingPitLookUpPage }); 
  });

  test('Search with special characters in Symbol field is handled gracefully', { tag: ['@Regression', '@SLL-206'] }, async ({ Given, When, Then, And, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
  ...
  test('Ag-Grid empty state overlay is visible before any search is performed', { tag: ['@Regression', '@SLL-206'] }, async ({ Given, When, Then, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
    await Then('the Lending Pit Ag-Grid should display the empty state overlay', null, { searchLendingPitLookUpPage }); 
  });

  test('Ag-Grid columns remain correctly aligned after horizontal scrolling', { tag: ['@Regression', '@SLL-206'] }, async ({ Given, When, Then, And, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
    await When('the user enters a valid symbol in the search field', null, { searchLendingPitLookUpPage }); 
    await And('the user clicks the submit button', null, { searchLendingPitLookUpPage }); 
  ...
  test('Page retains visual consistency when browser viewport is resized', { tag: ['@Regression', '@SLL-206'] }, async ({ Given, When, Then, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
    await Then('the Lending Pit page container should have consistent theme colors applied', null, { searchLendingPitLookUpPage }); 
  });
  ...
  test.describe('Multiple symbol searches with valid, invalid, and empty inputs', () => {
    ...
    test('Example #1', { tag: ['@Regression', '@SLL-206'] }, async ({ Given, When, Then, And, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
    ...
    test('Example #2', { tag: ['@Regression', '@SLL-206'] }, async ({ Given, When, Then, And, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
    ...
    test('Example #3', { tag: ['@Regression', '@SLL-206'] }, async ({ Given, When, Then, And, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
      await When('the user enters "NVDA" in the Lending Pit search field', null, { searchLendingPitLookUpPage }); 
      await And('the user clicks the submit button', null, { searchLendingPitLookUpPage }); 
      await Then('the expected search outcome should be "results shown"', null, { searchLendingPitLookUpPage }); 
    });

    test('Example #4', { tag: ['@Regression', '@SLL-206'] }, async ({ Given, When, Then, And, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
      await When('the user enters "GOOGL" in the Lending Pit search field', null, { searchLendingPitLookUpPage }); 
      await And('the user clicks the submit button', null, { searchLendingPitLookUpPage }); 
      await Then('the expected search outcome should be "results shown"', null, { searchLendingPitLookUpPage }); 
    });

    test('Example #5', { tag: ['@Regression', '@SLL-206'] }, async ({ Given, When, Then, And, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
      await When('the user enters "ZZZZINVALID" in the Lending Pit search field', null, { searchLendingPitLookUpPage }); 
      await And('the user clicks the submit button', null, { searchLendingPitLookUpPage }); 
    ...
    test('Example #6', { tag: ['@Regression', '@SLL-206'] }, async ({ Given, When, Then, And, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
      await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
      await When('the user navigates to the Lending Pit Lookup page', null, { searchLendingPitLookUpPage }); 
      await When('the user enters "" in the Lending Pit search field', null, { searchLendingPitLookUpPage }); 
      await And('the user clicks the submit button', null, { searchLendingPitLookUpPage }); 
  ...
  test('Full lifecycle — login, navigate to Lending Pit, verify Ag-Grid and consistent styling, search symbol, verify results', { tag: ['@Smoke', '@Regression', '@SLL-206'] }, async ({ Given, When, Then, And, contractSummaryPage, loginPage, page, searchLendingPitLookUpPage, testUsers }) => { 
