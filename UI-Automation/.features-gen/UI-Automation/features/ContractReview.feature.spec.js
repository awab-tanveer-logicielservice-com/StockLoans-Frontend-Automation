...
test.describe('Contract Review (SLL-208)', () => {
  ...
  test('User navigates to Contract Review and loads contracts by selecting a date', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractReviewPage, loginPage, page, testUsers }) => { 
  ...
  test('Contract Review page displays a list of unreviewed days on load', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, contractReviewPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Contract Review page', null, { contractReviewPage }); 
    await Then('a list of unreviewed days should be displayed for selection', null, { contractReviewPage }); 
  });

  test('User selects an unreviewed day from the list and reviewable contracts are loaded', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractReviewPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
  ...
  test('User selects contract rows, enters a comment, and submits a review successfully', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractReviewPage, loginPage, page, testUsers }) => { 
  ...
  test('Unreviewed-day list refreshes after a successful review submission', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, Then, And, contractReviewPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in with contract review permissions', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Review page', null, { contractReviewPage }); 
  ...
  test('User can select multiple contract rows for review submission', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractDetailsPage, contractReviewPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Review page', null, { contractReviewPage }); 
    await And('the user loads contracts for a reviewable date', null, { contractReviewPage }); 
  ...
  test('Review submission is blocked when no contract rows are selected', { tag: ['@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractReviewPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in with contract review permissions', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Review page', null, { contractReviewPage }); 
    await And('the user loads contracts for a reviewable date', null, { contractReviewPage }); 
  ...
  test('User can edit the review comment before submitting', { tag: ['@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractReviewPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in with contract review permissions', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Review page', null, { contractReviewPage }); 
    await And('the user loads contracts for a reviewable date', null, { contractReviewPage }); 
  ...
  test('Selecting a date with no reviewable contracts shows an empty state', { tag: ['@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractReviewPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Review page', null, { contractReviewPage }); 
  ...
  test('Invalid date entry in the date selector shows a validation error', { tag: ['@Regression', '@SLL-208'] }, async ({ Given, When, Then, And, contractReviewPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Contract Review page', null, { contractReviewPage }); 
  ...
  test('Authorized user can submit a contract review', { tag: ['@Smoke', '@Regression', '@SLL-208'] }, async ({ Given, When, Then, contractReviewPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in with contract review permissions', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Contract Review page', null, { contractReviewPage }); 
    await Then('the review submission controls should be visible and enabled', null, { contractReviewPage }); 
  });

  test('User without review permissions cannot submit a contract review', { tag: ['@Regression', '@SLL-208'] }, async ({ Given, When, Then, contractReviewPage, loginPage, page, testUsers }) => { 
