...
test.describe('Add New Modal Layouts — Users, Counterparty, and Entity (SLL-207)', () => {
  ...
  test('User clicks Add New button on the Users module and the modal opens', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
  ...
  test('User fills all required fields in the Add New User modal and saves successfully', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
  ...
  test('Add New User modal closes after a successful save', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Users module', null, { addNewModalLayoutsPage }); 
    await And('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
    await When('the user fills in all required fields in the Add New User modal', null, { addNewModalLayoutsPage }); 
  ...
  test('User clicks Add New button on the Counterparty module and the modal opens', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
  ...
  test('User fills all required fields in the Add New Counterparty modal and saves successfully', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
  ...
  test('Add New Counterparty modal closes after a successful save', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Counterparty module', null, { addNewModalLayoutsPage }); 
    await And('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
    await When('the user fills in all required fields in the Add New Counterparty modal', null, { addNewModalLayoutsPage }); 
  ...
  test('User clicks Add New button on the Entity module and the modal opens', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
  ...
  test('User fills all required fields in the Add New Entity modal and saves successfully', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
  ...
  test('Add New Entity modal closes after a successful save', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Entity module', null, { addNewModalLayoutsPage }); 
    await And('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
    await When('the user fills in all required fields in the Add New Entity modal', null, { addNewModalLayoutsPage }); 
  ...
  test('Add New User modal is centered on screen with theme-aware styling', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Users module', null, { addNewModalLayoutsPage }); 
  ...
  test('Add New Counterparty modal is centered on screen with theme-aware styling', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Counterparty module', null, { addNewModalLayoutsPage }); 
    await When('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
  ...
  test('Add New Entity modal is centered on screen with theme-aware styling', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Entity module', null, { addNewModalLayoutsPage }); 
    await When('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
  ...
  test('All three Add New modals share a consistent layout aligned with the SLS V2 design system', { tag: ['@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
  ...
  test('Add New button is visible and enabled on the Users module toolbar', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Users module', null, { addNewModalLayoutsPage }); 
    await Then('the Add New button should be visible and enabled on the toolbar', null, { addNewModalLayoutsPage }); 
  });

  test('Add New button is visible and enabled on the Counterparty module toolbar', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Counterparty module', null, { addNewModalLayoutsPage }); 
    await Then('the Add New button should be visible and enabled on the toolbar', null, { addNewModalLayoutsPage }); 
  });

  test('Add New button is visible and enabled on the Entity module toolbar', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Entity module', null, { addNewModalLayoutsPage }); 
    await Then('the Add New button should be visible and enabled on the toolbar', null, { addNewModalLayoutsPage }); 
  });

  test('Save button is disabled when the Add New User modal form is empty', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Users module', null, { addNewModalLayoutsPage }); 
    await When('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
  ...
  test('Save button is disabled when the Add New Counterparty modal form is empty', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Counterparty module', null, { addNewModalLayoutsPage }); 
    await When('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
    await Then('the Save button should be disabled', null, { addNewModalLayoutsPage }); 
  ...
  test('Save button is disabled when the Add New Entity modal form is empty', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Entity module', null, { addNewModalLayoutsPage }); 
    await When('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
    await Then('the Save button should be disabled', null, { addNewModalLayoutsPage }); 
  ...
  test('Save button becomes enabled when all required fields are populated in the Add New User modal', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Users module', null, { addNewModalLayoutsPage }); 
    await And('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
    await When('the user fills in all required fields in the Add New User modal', null, { addNewModalLayoutsPage }); 
  ...
  test('Save button becomes enabled when all required fields are populated in the Add New Counterparty modal', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Counterparty module', null, { addNewModalLayoutsPage }); 
    await And('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
    await When('the user fills in all required fields in the Add New Counterparty modal', null, { addNewModalLayoutsPage }); 
  ...
  test('Save button becomes enabled when all required fields are populated in the Add New Entity modal', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Entity module', null, { addNewModalLayoutsPage }); 
    await And('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
    await When('the user fills in all required fields in the Add New Entity modal', null, { addNewModalLayoutsPage }); 
  ...
  test('User cancels the Add New User modal without saving — no record created and grid unchanged', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Users module', null, { addNewModalLayoutsPage }); 
    await And('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
  ...
  test('User cancels the Add New Counterparty modal without saving — no record created and grid unchanged', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Counterparty module', null, { addNewModalLayoutsPage }); 
    await And('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
    await When('the user closes the modal without saving', null, { addNewModalLayoutsPage }); 
  ...
  test('User cancels the Add New Entity modal without saving — no record created and grid unchanged', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Entity module', null, { addNewModalLayoutsPage }); 
    await And('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
    await When('the user closes the modal without saving', null, { addNewModalLayoutsPage }); 
  ...
  test('Submitting Add New User modal with a missing required field keeps Save disabled', { tag: ['@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Users module', null, { addNewModalLayoutsPage }); 
    await And('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
  ...
  test('Submitting Add New Counterparty modal with a missing required field keeps Save disabled', { tag: ['@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Counterparty module', null, { addNewModalLayoutsPage }); 
    await And('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
  ...
  test('Submitting Add New Entity modal with a missing required field keeps Save disabled', { tag: ['@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Entity module', null, { addNewModalLayoutsPage }); 
    await And('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
  ...
  test('Duplicate record submission in Add New User modal shows an appropriate error', { tag: ['@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Users module', null, { addNewModalLayoutsPage }); 
    await And('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
  ...
  test('Duplicate record submission in Add New Counterparty modal shows an appropriate error', { tag: ['@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Counterparty module', null, { addNewModalLayoutsPage }); 
    await And('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
  ...
  test('Duplicate record submission in Add New Entity modal shows an appropriate error', { tag: ['@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in to the application', null, { loginPage, page, testUsers }); 
    await And('the user navigates to the Entity module', null, { addNewModalLayoutsPage }); 
    await And('the user clicks the Add New button', null, { addNewModalLayoutsPage }); 
  ...
  test('Read-only user cannot access the Add New button on the Users module', { tag: ['@Regression', '@SLL-207'] }, async ({ Given, When, Then, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
  ...
  test('Read-only user cannot access the Add New button on the Counterparty module', { tag: ['@Regression', '@SLL-207'] }, async ({ Given, When, Then, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in with read-only permissions', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Counterparty module', null, { addNewModalLayoutsPage }); 
    await Then('the Add New button should not be available or should be disabled', null, { addNewModalLayoutsPage }); 
  });

  test('Read-only user cannot access the Add New button on the Entity module', { tag: ['@Regression', '@SLL-207'] }, async ({ Given, When, Then, addNewModalLayoutsPage, loginPage, page, testUsers }) => { 
    await Given('the user is logged in with read-only permissions', null, { loginPage, page, testUsers }); 
    await When('the user navigates to the Entity module', null, { addNewModalLayoutsPage }); 
    await Then('the Add New button should not be available or should be disabled', null, { addNewModalLayoutsPage }); 
  });

  test('Full lifecycle — add new User, Counterparty, and Entity records and verify all grids refresh', { tag: ['@Smoke', '@Regression', '@SLL-207'] }, async ({ Given, When, Then, And, addNewModalLayoutsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
