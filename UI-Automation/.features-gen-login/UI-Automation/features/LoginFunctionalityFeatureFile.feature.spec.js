...
test.describe('Login Functionality - Firebase Authentication', () => {
  ...
  test('Successful login with valid credentials redirects to Contract Summary dashboard', { tag: ['@smokeBDD', '@Smoke', '@Regression', '@SLL-169'] }, async ({ Given, When, Then, And, contractDetailsPage, contractSummaryPage, loginPage, page, testUsers }) => { 
