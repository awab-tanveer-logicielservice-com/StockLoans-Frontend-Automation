...
test.describe('Remember Me Functionality in Login Component (SLL-171)', () => {
  ...
  test('Remember Me checkbox is visible on the login page', { tag: ['@smokeBDD', '@Smoke', '@Regression', '@SLL-171'] }, async ({ Given, Then, page, rememberMePage }) => { 
  ...
  test('Remember Me checkbox is unchecked by default', { tag: ['@smokeBDD', '@Smoke', '@Regression', '@SLL-171'] }, async ({ Given, Then, page, rememberMePage }) => { 
    await Given('the user is on the login page', null, { page, rememberMePage }); 
    await Then('the Remember Me checkbox should be unchecked by default', null, { rememberMePage }); 
  });

  test('User checks Remember Me and logs in — credentials are populated on next visit', { tag: ['@smokeBDD', '@Smoke', '@Regression', '@SLL-171'] }, async ({ Given, When, Then, And, page, rememberMePage, testUsers }) => { 
    await Given('the user is on the login page', null, { page, rememberMePage }); 
  ...
  test('Remember Me checkbox is checked on return visit when credentials were previously saved', { tag: ['@smokeBDD', '@Smoke', '@Regression', '@SLL-171'] }, async ({ Given, When, Then, And, page, rememberMePage, testUsers }) => { 
  ...
  test('User with pre-filled credentials can log in immediately without re-entering details', { tag: ['@smokeBDD', '@Smoke', '@Regression', '@SLL-171'] }, async ({ Given, When, Then, page, rememberMePage, testUsers }) => { 
    await Given('the user previously logged in with Remember Me enabled', null, { page, rememberMePage, testUsers }); 
    await When('the user navigates back to the login page', null, { rememberMePage }); 
  ...
  test('User logs in without checking Remember Me — credentials are not saved', { tag: ['@smokeBDD', '@Smoke', '@Regression', '@SLL-171'] }, async ({ Given, When, Then, And, page, rememberMePage, testUsers }) => { 
    await Given('the user is on the login page', null, { page, rememberMePage }); 
    await When('the user enters a valid email address', null, { rememberMePage, testUsers }); 
    await And('the user enters a valid password', null, { rememberMePage, testUsers }); 
  ...
  test('Remember Me checkbox remains unchecked on return visit when not previously enabled', { tag: ['@smokeBDD', '@Regression', '@SLL-171'] }, async ({ Given, When, Then, And, page, rememberMePage, testUsers }) => { 
  ...
  test('Credentials are stored in localStorage when Remember Me is enabled', { tag: ['@smokeBDD', '@Smoke', '@Regression', '@SLL-171'] }, async ({ Given, When, Then, And, page, rememberMePage, testUsers }) => { 
    await Given('the user is on the login page', null, { page, rememberMePage }); 
  ...
  test('Credentials are not stored in localStorage when Remember Me is disabled', { tag: ['@smokeBDD', '@Smoke', '@Regression', '@SLL-171'] }, async ({ Given, When, Then, And, page, rememberMePage, testUsers }) => { 
    await Given('the user is on the login page', null, { page, rememberMePage }); 
    await When('the user enters valid credentials', null, { rememberMePage, testUsers }); 
    await And('the Remember Me checkbox is unchecked', null, { rememberMePage }); 
    await And('the user clicks the Login button', null, { rememberMePage }); 
  ...
  test('Stored credentials are cleared when the user unchecks Remember Me and logs in', { tag: ['@smokeBDD', '@Smoke', '@Regression', '@SLL-171'] }, async ({ Given, When, Then, And, page, rememberMePage, testUsers }) => { 
    await Given('the user previously logged in with Remember Me enabled', null, { page, rememberMePage, testUsers }); 
  ...
  test('Stored credentials are cleared when the user manually unchecks Remember Me without logging in', { tag: ['@smokeBDD', '@Regression', '@SLL-171'] }, async ({ Given, When, Then, page, rememberMePage, testUsers }) => { 
  ...
  test('Both email and password fields are auto-populated when Remember Me was previously enabled', { tag: ['@smokeBDD', '@Smoke', '@Regression', '@SLL-171'] }, async ({ Given, When, Then, page, rememberMePage, testUsers }) => { 
    await Given('the user previously logged in with Remember Me enabled', null, { page, rememberMePage, testUsers }); 
  ...
  test('Auto-populated credentials can be edited before submitting login', { tag: ['@smokeBDD', '@Regression', '@SLL-171'] }, async ({ Given, When, Then, And, page, rememberMePage, testUsers }) => { 
    await Given('the user navigates to the login page with pre-filled credentials from a previous Remember Me session', null, { page, rememberMePage, testUsers }); 
  ...
  test('Auto-populated password field remains masked', { tag: ['@smokeBDD', '@Regression', '@SLL-171'] }, async ({ Given, When, Then, page, rememberMePage, testUsers }) => { 
    await Given('the user previously logged in with Remember Me enabled', null, { page, rememberMePage, testUsers }); 
    await When('the user navigates back to the login page', null, { rememberMePage }); 
    await Then('the auto-populated password should be displayed as masked characters', null, { rememberMePage }); 
  });

  test('Logging in with Remember Me overwrites previously saved credentials for a different user', { tag: ['@smokeBDD', '@Regression', '@SLL-171'] }, async ({ Given, When, Then, And, page, rememberMePage, testUsers }) => { 
  ...
  test('Remember Me does not bypass Firebase Authentication — valid credentials are still required', { tag: ['@smokeBDD', '@Smoke', '@Regression', '@SLL-171'] }, async ({ Given, When, Then, And, page, rememberMePage, testUsers }) => { 
    await Given('the user navigates to the login page with pre-filled credentials from a previous Remember Me session', null, { page, rememberMePage, testUsers }); 
    await When('the user clicks the Login button', null, { rememberMePage }); 
  ...
  test('Full lifecycle — login with Remember Me, logout, return and verify pre-fill, uncheck and verify cleared', { tag: ['@smokeBDD', '@Smoke', '@Regression', '@SLL-171'] }, async ({ Given, When, Then, And, loginPage, page, rememberMePage, testUsers }) => { 
